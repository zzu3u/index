$(document).ready(function(){
    ...
    $(".seoulopen").click(function(){
        $(".seoul").show();
        $(".now").hide();
    })
    $(".seoulclose").click(function(){
        $(".seoul").hide();
    })
    $(".floorunder1bt").click(function(){
        $(".floorunder1").show();
        $(".floor1").hide();
        $(".floor2").hide();
        $(".floor3").hide();
        $(".floorunder1btfix").show();
        $(".floor1btfix").hide();
        $(".floor3btfix").hide();
        $(".floor2btfix").hide();
    })
    $(".floor1bt").click(function(){
        $(".floor1").show();
        $(".floorunder1").hide();
        $(".floor2").hide();
        $(".floor3").hide();
        $(".floor1btfix").show();
        $(".floorunder1btfix").hide();
        $(".floor3btfix").hide();
        $(".floor2btfix").hide();
    })
    $(".floor2bt").click(function(){
        $(".floor2").show();
        $(".floorunder1").hide();
        $(".floor1").hide();
        $(".floor3").hide();
        $(".flooruunder1btfix").hide();
        $(".floor1btfix").hide();
        $(".floor3btfix").hide();
        $(".floor2btfix").show();
    })
    $(".floor3bt").click(function(){
        $(".floor3").show();
        $(".floor1").hide();
        $(".floorunder1").hide();
        $(".floor2").hide();
